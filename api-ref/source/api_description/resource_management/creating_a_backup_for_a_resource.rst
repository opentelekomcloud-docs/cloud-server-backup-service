...
-  Parameter description of field **protect_param**
   ...
   .. table:: **Table 3** Parameter description of field **protect_param**
      ...
      |                 |                 |                    |                                                                                                                                                                                            |
      |                 |                 |                    | The current value is **OS::Nova::Server** indicating that the backup object is an ECS. If this parameter is not transferred, the backup object type defaults to **OS::Nova::Server**.      |
      +-----------------+-----------------+--------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
