...
project = 'Cloud Server Backup Service'
otcdocs_repo_name = 'opentelekomcloud-docs/cloud-server-backup-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/cloud-server-backup-service/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'storage'
otcdocs_service_title = 'Cloud Server Backup Service'
otcdocs_service_type = 'csbs'
...
html_title = "Cloud Server Backup Service - API Reference"
